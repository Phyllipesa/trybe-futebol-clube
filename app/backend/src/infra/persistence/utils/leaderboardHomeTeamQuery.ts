const leaderboardHomeTeamQuery = `WITH team_stats AS (
    SELECT 
        t.team_name AS name,
...
FROM team_stats
ORDER BY totalPoints DESC, efficiency DESC, goalsFavor DESC, goalsBalance DESC;
`;

export default leaderboardHomeTeamQuery;
